...
//        print(path.bounds.maxX, path.bounds.maxY)
//        path.move(to: CGPoint(x: path.bounds.maxX, y: path.bounds.maxY))
//        path.addLine(to: CGPoint(x: path.bounds.maxX, y: path.bounds.minY))
//        path.addLine(to: CGPoint(x: path.bounds.minX, y: path.bounds.minY))
//        path.addLine(to: CGPoint(x: path.bounds.minX, y: path.bounds.maxY))
//        path.close()
        path.apply(CGAffineTransform.identity
